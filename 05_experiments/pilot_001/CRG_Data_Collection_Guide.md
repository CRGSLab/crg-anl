...
*   Top confusion moments (what confused you most?)
*   Momentum moments (when did you feel really engaged?)
*   [Unnamed box]
*   [Unnamed box]
...
**Not required to get started!** This step is for advanced users who want deeper analysis of individual events. You can skip it entirely and still contribute valuable data.
...
```
Session ID: pilot001-session-2026-07-27-1435
Events logged: 3
